package com.Sunshine.ToolBox.activities
...
import com.Sunshine.store.SpfConfig
import com.Sunshine.store.XposedExtension
import com.Sunshine.ui.IntInputFilter
import com.Sunshine.vaddin.IAppConfigAidlInterface
...
class ActivityAppXposedDetails : ActivityBase() {
    ...
    fun getAddinVersion(): Int {
        ...
        try {
            ...
            val info = manager.getPackageInfo("com.Sunshine.vaddin", 0)
    ...
    private fun bindService() {
        ...
        try {
            val intent = Intent();
            //绑定服务端的service
            intent.setAction("com.Sunshine.vaddin.ConfigUpdateService");
            //新版本（5.0后）必须显式intent启动 绑定服务
            intent.setComponent(ComponentName("com.Sunshine.vaddin", "com.Sunshine.vaddin.ConfigUpdateService"));
            //绑定的时候服务端自动创建
    ...
    private fun checkXposedState() {
        ...
        try {
            vAddinsInstalled = packageManager.getPackageInfo("com.Sunshine.vaddin", 0) != null
